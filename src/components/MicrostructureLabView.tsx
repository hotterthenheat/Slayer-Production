                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="z-10">
                              ...
                              >
                                {ask.type === 'WALL' ? ' LIMIT WALL' : ask.type === 'ICEBERG' ? ' ICEBERG' : ask.type === 'SPOOF' ? '️ SPOOF FLAG' : 'MM LIMIT'}
                              </span>
                            </div>
                          </div>
                        );
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="z-10">
                              ...
                              >
                                {bid.type === 'WALL' ? ' LIMIT WALL' : bid.type === 'ICEBERG' ? ' ICEBERG' : bid.type === 'SPOOF' ? '️ SPOOF FLAG' : 'MM LIMIT'}
                              </span>
                            </div>
                          </div>
                        );
