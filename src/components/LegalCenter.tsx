...
const DOCS: LegalDoc[] = [
  {
    ...
    short: 'Terms',
    icon: Scale,
    contact: 'legal@slayerterminal.com',
    ...
    sections: [
      ...
      { h: '15. Contact', p: ['Questions about these Terms can be sent to legal@slayerterminal.com.'] },
    ],
  },
  {
    id: 'privacy',
    ...
    short: 'Privacy',
    icon: ShieldCheck,
    contact: 'privacy@slayerterminal.com',
    ...
    sections: [
      ...
      { h: '8. Your Rights', p: ['Depending on your location, you may have the right to access, correct, delete, or port your data, object to or restrict certain processing, and opt out of marketing. To exercise these rights, contact privacy@slayerterminal.com. We will respond as required by applicable law.'] },
      ...
      { h: '12. Contact', p: ['For privacy questions or requests, email privacy@slayerterminal.com.'] },
    ],
  },
  {
    id: 'risk',
  ...
  },
  {
    ...
    icon: RefreshCcw,
    contact: 'support@slayerterminal.com',
    intro: `This policy explains how subscriptions, cancellations, and refunds work for ${COMPANY}.`,
    sections: [
      ...
      { h: '2. How to Cancel', p: ['You can cancel anytime from your account settings or by emailing support@slayerterminal.com. Cancellation stops future renewals; you keep access through the end of the period you have already paid for.'] },
      { h: '3. Refund Eligibility', p: ['Because the Service grants immediate access to digital analytics, fees are generally non-refundable except where required by law. We may, at our discretion, issue prorated or full refunds in cases of duplicate billing or verified technical failure that prevented access.'] },
      { h: '4. One-Time & Lifetime Purchases', p: ['One-time or lifetime purchases grant access under the plan terms in effect at purchase. Unless required by law, they are non-refundable after access has been provided.'] },
      ...
      { h: '6. Contact', p: ['For billing questions or refund requests, email support@slayerterminal.com.'] },
    ],
  },
  {
    id: 'cookies',
    ...
    sections: [
      ...
      { h: '6. Contact', p: ['Questions can be sent to privacy@slayerterminal.com.'] },
    ],
  },
];
